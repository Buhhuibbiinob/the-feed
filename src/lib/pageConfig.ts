...
export const PAGE_MODULES: ModuleDef[] = [
  // Profile
  { id: "mood", label: "Mood ring", surfaces: ["profile"], hint: "An emoji, a colour and a few words." },
  { id: "about", label: "About me", surfaces: ["profile", "club"], hint: "Your bio, with light formatting." },
  { id: "anthem", label: "Anthem", surfaces: ["profile", "club"], hint: "A track pinned to the page." },
  { id: "obsessed", label: "Currently obsessed with", surfaces: ["profile"] },
  { id: "blurbs", label: "Blurbs", surfaces: ["profile"], hint: "What you'd like to review next." },
  { id: "connections", label: "Top connections", surfaces: ["profile"], hint: "Your Top 8." },
  { id: "pinned", label: "Featured reviews", surfaces: ["profile", "club"], hint: "Reviews you pin yourself." },
  { id: "week", label: "Week in taste", surfaces: ["profile"] },
  { id: "twin", label: "Taste twin", surfaces: ["profile"] },
  { id: "highlights", label: "Standout reviews", surfaces: ["profile"] },
  { id: "collections", label: "Collections", surfaces: ["profile"] },
  { id: "favorites", label: "Top artists, movies & shows", surfaces: ["profile"] },
  { id: "achievements", label: "Achievements", surfaces: ["profile"] },
  { id: "stats", label: "Stats", surfaces: ["profile", "club"] },
  { id: "clubs", label: "Clubs", surfaces: ["profile"] },
  { id: "guestbook", label: "Guestbook", surfaces: ["profile", "club"], hint: "A public wall anyone can sign." },
  { id: "presence", label: "Views & last online", surfaces: ["profile"] },
  { id: "reviews", label: "Reviews", surfaces: ["profile", "club"] },
  // Club
  { id: "info", label: "About this artist", surfaces: ["club"], hint: "A wiki-style info panel." },
  { id: "members", label: "Members", surfaces: ["club"] },
];
