...
export const PAGE_MODULES: ModuleDef[] = [
  ...
  { id: "anthem", label: "Anthem", surfaces: ["profile", "club"], hint: "A track pinned to the page.", column: "side", defaultOn: true },
  { id: "about", label: "About me", surfaces: ["profile", "club"], hint: "Your bio, with light formatting.", column: "side", defaultOn: true },
  ...
  { id: "favorites", label: "Top artists, movies & shows", surfaces: ["profile"], column: "side", defaultOn: true },
  { id: "stats", label: "Stats", surfaces: ["profile", "club"], column: "side", defaultOn: true },
  ...
  { id: "info", label: "About this artist", surfaces: ["club"], hint: "A wiki-style info panel.", column: "side", defaultOn: true },
  // Main column: the things you actually read.
  { id: "obsessed", label: "Currently obsessed with", surfaces: ["profile"], column: "main", defaultOn: true },
  ...
  { id: "guestbook", label: "Guestbook", surfaces: ["profile", "club"], hint: "A public wall anyone can sign.", column: "main", defaultOn: true },
